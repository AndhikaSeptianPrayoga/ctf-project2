          ...
          <div class="inside-content">
            ...
            <div class="header">
                <a class="navbar-brand" href="#"><span>CTFin</span><span>AJA</span></a>
                              <div class="lead mb-3 text-mono text-success">Relax to answers the Quiz, We know you can do it !!!</div>
            </div>
                  ...
                  <div class="card-body">
                      ...
                      <form>
                          ...
                          <div class="submit-btn">
                            <a href="#"
                            title="Submit"
                            class="btn btn-success btn-shadow px-5 my-4 ml-0 text-left">
                            SUBMIT
                          </a>
                          </div>
                      </form>
