...
<script>
  function closeFilter(filterId) {
    ...
    document.getElementById(filterId + "-options").classList.remove("show");
  }

  function selectFilter(filterId, filterValue) {
    document.getElementById(filterId).innerHTML = filterValue + "<span class='close-icon' onclick='closeFilter(\"" + filterId + "\")'>X</span>";
    document.getElementById(filterId + "-options").classList.remove("show");
  }
  ...
  document.addEventListener("click", function(e) {
    ...
    if (!filterSelect.contains(e.target) && !e.target.classList.contains("close-icon")) {
  ...
  document.addEventListener("click", function(e) {
    if (e.target.classList.contains("filter-select") || e.target.classList.contains("close-icon")) {
      const filterSelect = e.target.closest(".filter-select");
      const filterOptions = filterSelect.nextElementSibling;
